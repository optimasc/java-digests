...
*  The information in this code is based on the code of the FLAC codec.
...
*
*/
public final class CRC8Digest extends MessageDigestSpi
{
  ...
  {
    hashValue = crc8table[hashValue ^ input];
  }
  ...
  protected void engineUpdate(byte[] input, int offset, int len)
  {
    ...
    while ((len--)>0)
    {
      crc = crc8table[crc ^ input[offset]];
      offset++;
    }
    hashValue = crc;
  }
